...
public class CrazyGenerics {
    ...
    /**
     * {@link ComparableCollection} is a {@link Collection} that can be compared by size. It extends the {@link Collection}
     * interface and {@link Comparable} interface, providing a default implementation of the {@code compareTo} method that
     * compares the sizes of two collections.
     * <p>
     * It is important to note that size comparison does not depend on the element types, allowing collections of different
     * types to be compared by size.
     *
     * @param <E> the type of elements in the collection
     */
    public interface ComparableCollection<E> extends Collection<E>, Comparable<Collection<?>> {

        /**
         * Compares this collection with the specified collection based on their sizes.
         *
         * @param other the collection to compare with
         * @return a negative integer, zero, or a positive integer as this collection is smaller than, equal to, or larger
         *         than the specified collection
         */
        @Override
    ...
    static class CollectionUtil {
         ...
         *
         * @param list provided list of elements
         */
         ...
         * <p>
         * This method reuses findMax method and passes entities along with prepared comparator instance,
        ...
        public static void swap(List<?> elements, int i, int j) {
            ...
            final List<Object> list = (List<Object>) elements;
